export type ProductParams = {
    _fields?: string[], //'id,name,prices'
    per_page?: number,
    page?: number,
    search?: string, // search=product%20name
    slug?: string[],  // slug-1,slug-2
    after?: string, //after=2017-03-22&date_column=date
    before?: string, //before=2017-03-22&date_column=date
    date_column?: string, //date_column=date
    exclude?: number[], //exclude=10,44,33
    include?: number[], //include=10,44,33
    offset?: number,
    order?: Order,
    orderby?: OrderBy,
    parent?: number[], //parent=10
    parent_exclude?: number[], // parent_exclude=10
    type?: string,
    sku?: string[], // sku=sku-1,sku-2
    featured?: boolean,
    category?: string, //category=22
    category_operator?: Operator,
    ['product-taxonomy']: string, //product-taxonomy=product-taxonomy-term-id
    tag?: string, // tag=special-items
    tag_operator?: Operator,
    on_sale?: boolean,
    min_price?: number,
    max_price?: number,
    stock_status?: Array<StockStatus>, //stock_status=['outofstock']
    attributes?: string, //attributes[0][attribute]=pa_color&attributes[0][slug]=red
    attribute_relation?: Operator,
    catalog_visibility?: Visibility,
    rating?: string, //rating=4,5
    return_price_range?: boolean,
    return_attribute_counts?: string | string[], //return_attribute_counts=pa_size,pa_color
    return_rating_counts?: boolean,
    // attributes? : Array<{ attribute: string, slug: string }>,
}
